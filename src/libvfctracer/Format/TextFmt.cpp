...
_LLVMFunctionType TextFmt::CreateProbeFunctionPrototype(Data &D) {

  const std::string dataTypeName = D.getDataTypeName();
  std::string probeFunctionName = vfctracer::probePrefixName + dataTypeName;
...
CallInst *TextFmt::InsertProbeFunctionCall(Data &D,
                                           _LLVMFunctionType probeFunc) {
