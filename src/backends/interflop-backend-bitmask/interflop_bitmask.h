...
#define BITMASK_PRECISION_BINARY32_MAX FLOAT_PREC
#define BITMASK_PRECISION_BINARY64_MAX DOUBLE_PREC
#define BITMASK_PRECISION_BINARY32_DEFAULT FLOAT_PREC
#define BITMASK_PRECISION_BINARY64_DEFAULT DOUBLE_PREC
