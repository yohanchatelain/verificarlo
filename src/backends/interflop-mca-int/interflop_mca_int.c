 ...
 * generation */
thread_local rng_state_t rng_state;
...
static inline void _noise_binary64(double *x, const int exp,
  ...
  int64_t noise = _get_rand_uint64(rng_state, &global_tid) & 0xFFFFFFFF00000000;
...
static void _noise_binary128(__float128 *x, const int exp,
  ...
  binary128 noise = {.words64.high = _get_rand_uint64(rng_state, &global_tid)};
