...
$CLANGXX -S -emit-llvm src/sr_hw.cpp -DHWY_COMPILE_ONLY_STATIC -march=native -O2 -USR_DEBUG -o sr_hw-native.ll -I. -Ibazel-rand/external/_main~_repo_rules~hwy/ -std=c++17 &
