...
# $CLANGXX -S -emit-llvm src/sr_hw.cpp -O2 -march=native -USR_DEBUG -o sr_hw-native.ll -I. -Ibazel-rand/external/_main~_repo_rules~hwy/ -std=c++17
# $CLANGXX -S -emit-llvm src/ud_hw.cpp -O2 -march=native -USR_DEBUG -o ud_hw-native.ll -I. -Ibazel-rand/external/_main~_repo_rules~hwy/ -std=c++17
