...
#if __COVERITY__
#if !defined(COVERITY_COMPAT_0f14eb91137e95095feb026fe9bb5d7f)
#define COVERITY_COMPAT_0f14eb91137e95095feb026fe9bb5d7f
...
typedef int __Int64x1_t __attribute__((vector_size (8)));
typedef float __Float16x4_t __attribute__((vector_size (8)));
typedef float __Float32x2_t __attribute__((vector_size (8)));
typedef unsigned char __Poly8x8_t  __attribute__((vector_size (8)));
typedef short __Poly16x4_t __attribute__((vector_size (8)));
...
typedef float __Float64x1_t __attribute__((vector_size (8)));
typedef unsigned int __Uint64x1_t __attribute__((vector_size (8)));
...
typedef int __Int64x2_t __attribute__((vector_size (16)));
typedef float __Float16x8_t __attribute__((vector_size (16)));
typedef float __Float32x4_t __attribute__((vector_size (16)));
typedef float __Float64x2_t __attribute__((vector_size (16)));
typedef unsigned char __Poly8x16_t __attribute__((vector_size (16)));
typedef unsigned short __Poly16x8_t __attribute__((vector_size (16)));
typedef int __Poly64x2_t __attribute__((vector_size (16)));
...
typedef unsigned int __Uint64x2_t  __attribute__((vector_size (16)));
typedef unsigned char __Poly8_t;
typedef unsigned short __Poly16_t;
typedef int __Poly64_t __attribute__((vector_size (8)));
typedef int __Poly128_t __attribute__((vector_size (16)));
...
__Uint32x4_t __builtin_aarch64_lshrv4si (__Uint32x4_t, const int);
__Uint64x2_t __builtin_aarch64_lshrv2di (__Uint64x2_t, const int);
...
__Int64x2_t __builtin_aarch64_combinedi (__Int64x1_t *, __Int64x1_t *);
...
__Float32x2_t __builtin_aarch64_absv2sf (__Float32x2_t __a);
...
__Int32x4_t __builtin_aarch64_sqdmlal2_nv8hi (__Int32x4_t __a, __Int16x8_t __b, int16_t __c);
...
__Int32x4_t __builtin_aarch64_sqdmlal_nv4hi (__Int32x4_t __a, __Int16x4_t __b, int16_t __c);
...
__Int64x2_t __builtin_aarch64_sqdmlal2_nv4si (__Int64x2_t __a, __Int32x4_t __b, int32_t __c);
...
__Int64x2_t __builtin_aarch64_sqdmlal_nv2si (__Int64x2_t __a, __Int32x2_t __b, int32_t __c);
...
__Int32x4_t __builtin_aarch64_sqdmlsl2_nv8hi (__Int32x4_t __a, __Int16x8_t __b, int16_t __c);
...
__Int32x4_t __builtin_aarch64_sqdmlsl_nv4hi (__Int32x4_t __a, __Int16x4_t __b, int16_t __c);
...
__Int64x2_t __builtin_aarch64_sqdmlsl2_nv4si (__Int64x2_t __a, __Int32x4_t __b, int32_t __c);
...
__Int64x2_t __builtin_aarch64_sqdmlsl_nv2si (__Int64x2_t __a, __Int32x2_t __b, int32_t __c);
...
__Int32x4_t __builtin_aarch64_sqdmull2_nv8hi (__Int16x8_t __a, int16_t __b);
...
__Int32x4_t __builtin_aarch64_sqdmull_nv4hi (__Int16x4_t __a, int16_t __b);
...
__Int64x2_t __builtin_aarch64_sqdmull2_nv4si (__Int32x4_t __a, int32_t __b);
...
__Int64x2_t __builtin_aarch64_sqdmull_nv2si (__Int32x2_t __a, int32_t __b);
...
__Uint32x4_t __builtin_aarch64_crypto_sha1cv4si_uuuu (__Uint32x4_t hash_abcd, uint32_t hash_e, __Uint32x4_t wk);
__Uint32x4_t __builtin_aarch64_crypto_sha1mv4si_uuuu (__Uint32x4_t hash_abcd, uint32_t hash_e, __Uint32x4_t wk);
__Uint32x4_t __builtin_aarch64_crypto_sha1pv4si_uuuu (__Uint32x4_t hash_abcd, uint32_t hash_e, __Uint32x4_t wk);
...
__Uint32x4_t __builtin_aarch64_lshrv4si (__Int32x4_t __a, const int __b);
__Uint64x2_t __builtin_aarch64_lshrv2di (__Int64x2_t __a, const int __b);
...
/*
 * Beginning with GCC 8, we use the cov-emit --builtin_emulation switch to
 * handle Intel intrinsics in GCC.
 */
#define __COVERITY_DISABLE_BUILTIN_DECLS
#endif /* GCC >= 8.0 */
#ifdef __IA64__
...
typedef __float128 __coverity_floatx _Float64x;
typedef __float128 __coverity_float _Float128;
#endif /* defined(__SIZEOF_FLOAT128__) */
#endif /* GCC >= 7.0 */
#endif /* __cplusplus */
...
typedef struct __cov_bounds_type_s *__cov_bounds_type;
...
#pragma builtin end
#endif /* COVERITY_COMPAT_0f14eb91137e95095feb026fe9bb5d7f */
#endif /* __COVERITY__ */
