...
c---------------------------------------------------------------------
      program mainft
         implicit none
         include 'global.h'
c$$$         include 'gperftools/profiler.h'
 ...
 1000    format(//,' NAS Parallel Benchmarks (NPB3.0-SER)',
     >          ' - FT Benchmark', /)
 ...
 1002    format(' Iterations          :     ', i7)
	 ...
	 call getclass(class)
!
c$$$         call ProfilerStart("profile")
         call appft (niter, total_time, verified)
c$$$         call ProfilerStop("profile")
!     
